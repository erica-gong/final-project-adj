...
```
Findings: There are 28 columns missing data for all five years (2020-2025). There are 3 columns missing data for four years. There are 4 columns missing data for three years. There is 1 column missing data for one year.
